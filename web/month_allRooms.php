...
function month_table_innerhtml($day, $month, $year, $room, $area)
{
  ...
  for ($day_num = 1; $day_num<=$days_in_month; $day_num++)
  {
    ...
    $entries = get_entries_by_area($area, $start_first_slot, $end_last_slot);
    //get_entries_by_area($area_id, $start_first_slot, $start_last_slot + $resolution); 
    ...
    foreach($entries as $entry)
    {
      ...
      $d[$day_num]["data"][]         = get_booking_summary($entry['start_time'],
                                                           ...
                                                           $start_first_slot,
                                                           $end_last_slot);
      $d[$day_num]["roomname"][]     = get_room_name($entry['room_id']);
    }
  }
...
$href_before = "month.php?area=$area&amp;year=$yy&amp;month=$ym&amp;day=$yd";
$href_now    = "month.php?area=$area&amp;year=$cy&amp;month=$cm&amp;day=$cd";
$href_after  = "month.php?area=$area&amp;year=$ty&amp;month=$tm&amp;day=$td";
